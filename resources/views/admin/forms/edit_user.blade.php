                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            ...
                                            <input type="checkbox" class="form-check-input" id="status" name="status"
                                                value="1" {{ $details->status == 1 ? 'checked' : '' }}>
                                        </div>
                                    </div>
                                    <div class="form-group row ">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-5">
                                            <select class="form-control select2" name="role" style="width: auto;">
                                                ...
                                                <option value="0" {{ $details->role == 0 ? 'selected' : '' }}>Admin
                                                </option>
                                                <option value="1" {{ $details->role == 1 ? 'selected' : '' }}>Doctor
                                                </option>
                                                <option value="2" {{ $details->role == 2 ? 'selected' : '' }}>User
                                                </option>
                                            </select>
                                        </div>
                                    </div>
