    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validateStep(stepNumber) {
                ...
                const inputFields = step.querySelectorAll('input[required], select[required], textarea[required]');
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('addInput1').addEventListener('click', function() {
                const newRow = document.querySelector('.second-form').cloneNode(true);
                document.querySelector('.second-form').parentNode.appendChild(newRow);
            });
