                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="active tab-pane" id="english">
                                            ...
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" id="slug" name="slug"
                                                        placeholder="Page Slug" value="{{ $page->slug }}">
                                                    @error('slug')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="card-body">
                                                    <textarea id="summernote" name="content_en">{{ $page->content['en'] }}
                                          </textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="nepali">
                                            <div class="form-group row ">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" id="title_np"
                                                        name="title_np" placeholder="शीर्षक लेख्नुहोस्"
                                                        value="{{ $page->title['np'] }}">
                                                    @error('title')
                                                        <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                            ...
                                            <div class="form-group row">
                                                <div class="card-body">
                                                    <textarea id="summernote1" name="content_np">{{ $page->content['np'] }}
                                                    </textarea>
                                                </div>
                                            </div>
                                        </div>
